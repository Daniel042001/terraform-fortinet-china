...
# locals {
#   nameFgtvm64Byol = {
#     CHINA  = "FGT_VM64_AWS-v6.4.9.F-build1966*"
#     GLOBAL = "FortiGate-VM64-AWS build2093 (6.4.14) GA*"
#   }
#   nameFgtvm70Byol = {
#     CHINA  = "FGT_VM64_AWS-v7.0.7.F-build0367*"
#     GLOBAL = "FortiGate-VM64-AWS build0523 (7.0.12) GA*"
#   }
#   nameFgtvm72Byol = {
#     CHINA  = "FGT_VM64_AWS-v7.2.2.F-build1255*"
#     GLOBAL = "FortiGate-VM64-AWS build1517 (7.2.5) GA*"
#   }
# }
...
#   filter {
#     name   = "name"
#     values = var.licenseTypeFgt == "byol" ? [local.nameFgtvm64Byol[local.nameAwsLocation]] : [local.nameFgtvm64Payg[local.nameAwsLocation]]
#   }
...
#   filter {
#     name   = "name"
#     values = var.licenseTypeFgt == "byol" ? [local.nameFgtvm70Byol[local.nameAwsLocation]] : [local.nameFgtvm70Payg[local.nameAwsLocation]]
#   }
...
#   filter {
#     name   = "name"
#     values = var.licenseTypeFgt == "byol" ? [local.nameFgtvm72Byol[local.nameAwsLocation]] : [local.nameFgtvm72Payg[local.nameAwsLocation]]
#   }
...
locals {
  nameFgtByol = {
    CHINA  = "FortiGate-AWS-7.2.5_BYOL-Release*"
